...
export const projects: Project[] = [
  {
    ...
    images: [
      "https://images.unsplash.com/photo-1561070791-2526d30994b5?auto=format&fit=crop&w=800&h=1000&q=80",
      "https://images.unsplash.com/photo-1558618666-fcd25c85cd64?auto=format&fit=crop&w=800&h=1000&q=80",
      "https://images.unsplash.com/photo-1550684848-fac1c5b4e853?auto=format&fit=crop&w=800&h=1000&q=80",
      "https://images.unsplash.com/photo-1523438097201-512ae7d59c44?auto=format&fit=crop&w=800&h=1000&q=80",
      "https://images.unsplash.com/photo-1492144534655-ae79c964c9d7?auto=format&fit=crop&w=800&h=1000&q=80",
    ],
    year: "2024",
    category: "Design",
    description: "NEON FUTURES APPROACHED US TO RELAUNCH THEIR 'STAND OUT, NEVER STILL' CAMPAIGN FOR 2024. THE BRIEF: POSITION THE BRAND ALONGSIDE LEADING NAMES IN TECH DESIGN BY GROUNDING IT IN AUTHENTIC INNOVATION AND COMMUNITY-DRIVEN STORYTELLING. WE WORKED FROM CONCEPT TO LAUNCH, PRODUCING A CAMPAIGN THAT SPOTLIGHTED A DIVERSE ROSTER OF STANDOUT CREATORS AND SPARKED A MULTI-CHANNEL CONVERSATION THAT EXPANDED THE BRAND'S AUDIENCE AND CEMENTED ITS CREDIBILITY.",
  },
  {
    id: "ritual-commerce",
